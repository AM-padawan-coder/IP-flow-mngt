...
const PHASES: Phase[] = [
  ...
  { v: 'v2.11', title: 'Export DOCX des flux', status: 'planned', label: '🗓 Planifié', eta: '',
    items: [
      'Export Word (.docx) depuis le menu Flux : tableau stylisé (en-têtes colorés, lignes alternées, badges de statut)',
      'En-tête de document : titre, date de génération, filtres actifs appliqués et nombre de flux exportés',
      ...
      'Mémorisation du dernier jeu de champs sélectionné (préférence persistée)',
      'Respect des filtres actifs de la liste (statut, recherche) — cohérent avec l\'export CSV existant',
      'Nom de fichier horodaté : flux_AAAAMMJJ_HHMMSS.docx',
      'Remplacement de l\'icône « Aucun flux trouvé » par une icône Tabler (ti ti-file-search)',
    ] },
  { v: 'v2.12', title: 'Import avancé & configuration', status: 'planned', label: '🗓 Planifié', eta: '',
    items: [
  ...
  { v: 'v2.13', title: 'Tests de non régression', status: 'planned', label: '🗓 Planifié', eta: '',
