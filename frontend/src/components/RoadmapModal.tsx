...
const PHASES = [
  ...
  { v: 'v5.3', title: 'Compliance', status: 'inprog', label: '🔵 En cours', eta: '',
    items: ['✓ Socle livré (v2.8.2) : catalogue OSCAL, profils de source (NIS2/ANSSI/CIS), moteur générique + page Conformité', 'Enrichir le sujet avec le chemin réel calculé (au-delà de [zone_src, zone_dst])', 'Persister les verdicts (historique d\'audit) + export OSCAL Assessment Results', 'Élargir le catalogue : recommandations ANSSI R43/R44/R80, contrôles internes personnalisés', 'Agent LLM (API Claude) pour expliquer les findings et citer l\'article — jamais pour le verdict'] },
