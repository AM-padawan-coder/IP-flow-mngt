...
const PHASES: Phase[] = [
  ...
  { v: 'v2.10', title: 'Import avancé & configuration', status: 'soon', label: '🔜 Prochain', eta: '',
    items: [
  ...
  { v: 'v2.11', title: 'Logs & Traçabilité', status: 'planned', label: '🗓 Planifié', eta: '',
    items: ['Journal d\'actions utilisateurs : création, validation, suppression, import/export', 'Export des logs en CSV / JSON horodaté'] },
  { v: 'v2.12', title: 'Tests de non régression', status: 'planned', label: '🗓 Planifié', eta: '',
