...
const PHASES = [
  ...
  { v: 'v2.1', title: 'Guide FR + Déploiement', status: 'done', label: '✓ Livré', eta: '',
    items: ['Guide d\'utilisation intégré (10 sections, FAQ)', 'Roadmap accessible depuis la sidebar', 'Dark / Light mode', 'Déploiement Render (backend + static site)'] },
  { v: 'v2.2', title: 'Adaptateurs scripts & Audit', status: 'inprog', label: '⚡ En cours', eta: '2–3 sem',
    items: ['Adaptateur Juniper JunOS (firewall filter + routing-policy)', 'Adaptateur NSX-T REST API (DFW groupes + règles)', 'Adaptateur Fortinet FortiOS CLI', 'Adaptateur Check Point mgmt_cli (publish + install)', 'Audit enrichi — filtres période/zone/équipe, export CSV'] },
  { v: 'v3.0', title: 'Vérification avant production', status: 'soon', label: '🔜 Prochain', eta: '',
    items: ['Simulation What-if (tester sans appliquer)', 'Vérification avant changement — diff règles avant/après', 'Analyse d\'impact (quels flux cassés si équipement tombe ?)', 'Détection de boucles L2/L3 (DFS)', 'Joignabilité garantie (preuve formelle)'] },
  { v: 'v3.1', title: 'Connecteur IPAM Infoblox', status: 'soon', label: '🔜 Prochain', eta: '',
  ...
  { v: 'v3.2', title: 'Dark / Light mode', status: 'done', label: '✓ Livré', eta: '',
    items: ['Toggle ☀/🌙 dans la sidebar', 'Thème clair complet (toutes pages + graphe)', 'Détection automatique prefers-color-scheme', 'Persistance dans localStorage'] },
  { v: 'v4.0', title: 'Parcours de validation', status: 'planned', label: '🗓 Planifié', eta: '',
  ...
  { v: 'v4.2', title: 'Graphe réseau avancé', status: 'planned', label: '🗓 Planifié', eta: '',
    items: ['Vue hiérarchique (zones comme groupes visuels)', 'Mini-map de navigation pour grands graphes', 'Filtres dynamiques (zone, équipe, vendor)', 'Topology diff coloré (ajouts/suppressions)', 'Heatmap des liens selon densité de flux'] },
